//
//  PlacementOffhourViewController.swift
//  
//
...
class PlacementOffhourViewController: XBaseViewController {
    ...
    lazy var headerText: UITextView = {
        ...
        text.text = "We have received your placement instructions"
    ...
    lazy var infoText: UITextView = {
        ...
        text.isSelectable = false
        text.isScrollEnabled = false
        text.text = "We will inform you via email within X working days on the status of your application."
        text.textContainer.lineFragmentPadding = 0
        text.textContainerInset = UIEdgeInsets(top: 0, left: 0, bottom: 0, right: 0)
...
extension PlacementOffhourViewController {
