//
//  EarlyWithdrawalErrorViewController.swift
//  
//
...
class EarlyWithdrawalErrorViewController: XBaseViewController {
    
    let identifiers = XAccessibilityIdentifier.EarlyWithdrawal.Error.self
    ...
    lazy var topSectionImage: UIImageView = {
        ...
        image.image = UIImage(named: "acknowledgement-failed", in: Bundle.module, compatibleWith: .none)
        return image
    }()
    ...
    lazy var headerText: UITextView = {
        ...
        text.text = "Sorry, we are unable to process your request at this moment."
...
// MARK: User Actions
extension EarlyWithdrawalErrorViewController {
