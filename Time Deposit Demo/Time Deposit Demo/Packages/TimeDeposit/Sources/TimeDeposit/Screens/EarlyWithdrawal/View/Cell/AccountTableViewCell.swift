...
class AccountTableViewCell: UITableViewCell {
    ...
    var viewModel: EarlyWithdrawalFormViewModel.Item!
    ...
    func fill(with viewModel: EarlyWithdrawalFormViewModel.Item) {
        self.viewModel = viewModel
        accountShortName.text = viewModel.accountShortName
        accountName.text = viewModel.accountName
        accountNumber.text = viewModel.currency == .SGD ? viewModel.formattedAccountNo : "\(viewModel.formattedAccountNo) \(viewModel.currency.rawValue)"
    }
